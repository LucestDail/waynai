...
public class TouristSpotResponseDto {
    ...
    private List<TouristSpotDto> items;
    
    public TouristSpotResponseDto() {
        this.success = false;
    }
    
    public TouristSpotResponseDto(boolean success, String resultCode, String resultMsg) {
        this.success = success;
        this.resultCode = resultCode;
        this.resultMsg = resultMsg;
    }
    
    public static TouristSpotResponseDto success(TouristApiResponseDto apiResponse) {
        TouristSpotResponseDto response = new TouristSpotResponseDto();
        response.setSuccess(true);
        
        if (apiResponse != null && apiResponse.getResponse() != null) {
            TouristApiResponseDto.Response responseData = apiResponse.getResponse();
    ...
    public static TouristSpotResponseDto error(String resultCode, String resultMsg) {
        return new TouristSpotResponseDto(false, resultCode, resultMsg);
    }
}
